...
// //             </div>
// //             <div className='flex flex-col  items-center gap-3 lg:px-3 lg:flex-row w-full h-auto'>
// //                 <div className='w-full h-auto lg:w-1/2 '>
// //                     <video muted autoPlay loop className='aspect-video'>
// //                         <source src='https://res.cloudinary.com/dnrqpptic/video/upload/v1747888379/otopi0laalmmjrcqbtdy.mp4' type="video/mp4" />
// //                     </video>

// //                 </div>
// //                 <div className='w-full flex flex-col gap-5 lg:w-1/2'>
// //                     <h1 className='lg:text-4xl font-bold line-height_1_3 uppercase'>We will provide you the best work which you dreamt for!</h1>
// //                     <p className='text-base font-sans line-height-2 text-gray-500 font-[400]'>Hard workers persevere in large and small ways to the benefit of their personal and professional communities. Persistence is continued, extended effort toward a goal or outcome, regardless of challenges or obstacles.</p>
// //                     <button onClick={handleClick} className='w-fit px-3 py-3 text-lg bg-black text-white hover:bg-amber-400 transition-colors duration-500 ease-in-out hover:text-black'>Readme More</button>
// //                 </div>
...
// //                         <div key={index} className='min-w-[250px] grow flex flex-col gap-2 justify-center items-center h-[150px] bg-[#eee]'>
...
//   return (
//     <div className='flex py-5 flex-col gap-5' ref={containerRef}>
//       <motion.div
//         id='about'
//         initial="hidden"
//         animate={controls}
...
//         >
//           <video muted autoPlay loop className='aspect-video rounded-lg shadow-lg'>
//             <source src='https://res.cloudinary.com/dnrqpptic/video/upload/v1747888379/otopi0laalmmjrcqbtdy.mp4' type="video/mp4" />
//           </video>
//         </motion.div>
...
//         >
//           <h1 className='lg:text-4xl font-bold leading-[1.3] uppercase'>
//             We will provide you the best work which you dreamt for!
//           </h1>
//           <p className='text-base font-sans leading-7 text-gray-500 font-[400]'>
...
//           <button
//             onClick={handleClick}
//             className='w-fit px-3 py-3 text-lg bg-black text-white hover:bg-amber-400 transition-colors duration-500 ease-in-out hover:text-black rounded-md shadow-md hover:shadow-lg active:scale-95'
//           >
//             Read More
//           </button>
//         </motion.div>
...
//           <motion.div
//             key={index}
//             className='min-w-[250px] grow flex flex-col gap-2 justify-center items-center h-[150px] bg-[#eee] rounded-lg shadow-md'
//             initial="hidden"
//             animate={controls}
//             variants={scaleUp}
